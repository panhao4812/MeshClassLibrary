...
namespace FitAndInterpolation
{
    ...
    public class PI2
    {
        ...
        public List<string> ToExpression()
        {
            ...
            pa = RE.FromPIArray(new int[] { a, Filt(b - 1) }, _index);
            pb = RE.FromPIArray(new int[] { b, Filt(a - 1) }, _index);
            string str = "";
    ...
    public class PI4
    {
        ...
        public List<string> ToExpression()
        {
            ...
            pa = RE.FromPIArray(new int[] { a, Filt(b - 1) }, _index);
            pb = RE.FromPIArray(new int[] { b, Filt(c - 1) }, _index);
            pc = RE.FromPIArray(new int[] { c, Filt(d - 1) }, _index);
            pd = RE.FromPIArray(new int[] { d, Filt(a - 1) }, _index);
            string str = "";
            for (int i = 0; i < pa.Count; i++)
            {
                if (i > 0) str += "|";
    ...
    public class PI3
    {
        ...
        public List<string> ToExpression()
        {
            ...
            list_int.Add(a); list_int.Add(Filt(b - 1));
            list_int.Add(b); list_int.Add(Filt(c - 1));
            list_int.Add(c); list_int.Add(Filt(a - 1));
            list_int = list_int.Distinct<int>().ToList();
            if (list_int.Count != 6) return output;
            pa = RE.FromPIArray(new int[] { a, Filt(b - 1) }, _index);
            pb = RE.FromPIArray(new int[] { b, Filt(c - 1) }, _index);
            pc = RE.FromPIArray(new int[] { c, Filt(a - 1) }, _index);
            string str = "";
            for (int i = 0; i < pa.Count; i++)
            {
                if (i > 0) str += "|";
